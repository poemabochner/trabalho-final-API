...
public class ProdutoController {
	...
	public ResponseEntity<ProdutoDTO> inserir(@RequestPart MultipartFile file, @Valid @RequestPart(name = "produto") ProdutoInserirDTO produtoInserir) throws IOException {
